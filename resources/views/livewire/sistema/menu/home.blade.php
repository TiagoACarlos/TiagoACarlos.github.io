    ...
    <div class="grid">
        <div class=" bg-white border-b pb-4" style=" display: {{ $menuAtivo }};">
            <form wire:submit.prevent="salvar" class="grid lg:grid-cols-4 lg:gap-4 mt-16 px-5">
                ...
                <div class="mt-4">
                    <label for="" class=" text-sm font-semibold text-gray-600">Altura da Menu</label>
                    <input name="tamanho_menu" type="text" wire:model="tamanho_menu" class=" border rounded-md p-2 focus:outline-none block w-full h-14" placeholder="Altura da Menu">
                    @error('tamanho_menu') <span class="text-red-400 text-sm">{{ $message }}</span> @enderror
                </div> 
                {{-- <div class="mt-4">
